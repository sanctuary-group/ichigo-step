...
export function ChannelHealthCard({
    ...
    const toggleActive = () => {
        ...
        // /ban-detection からは「切替」フローで対応するため Inertia 経由で is_active を反転するエンドポイントは設けない。
        ...
        if (channel.is_active) {
            alert("「切替」ボタンから予備チャネルに移行してください (BAN 検知では単独の停止操作はサポート外)");
            return;
        }
                        ...
                        <table className="w-full text-xs">
                            <thead className="bg-muted/60">
                                <tr>
                                    ...
                                    <th className="px-3 py-2 text-center font-bold w-16">
                                        HTTP
                                    </th>
