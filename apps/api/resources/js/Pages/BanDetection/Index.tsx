                ...
                candidates={
                    switchDialog
                        ? channelHealth.filter(
                              (c) =>
                                  c.id !== switchDialog.id && !c.is_active,
                          )
                        : []
                }
...
BanDetectionIndex.layout = (page: React.ReactNode) => (
...
function SwitchDialog({
    ...
    const submit = () => {
        ...
        setSubmitting(true);
        router.post(
            "/ban-detection/switch",
            { from_channel_id: channel.id, to_channel_id: targetId },
            {
                preserveScroll: true,
